    ...
    <section class="relative bg-[#001c3d] py-16 lg:py-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
            ...
            <nav class="flex mb-4 text-xs font-semibold uppercase tracking-wider text-gray-400">
                ...
                <span class="text-[#f2bd11]">Nossos Serviços</span>
            </nav>
            
            <!-- Title and Subtitle -->
            <div class="max-w-3xl">
                <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight mb-4">
                    Nossos <span class="text-[#f2bd11]">Serviços</span>
                </h1>
                <p class="text-base sm:text-lg text-gray-300 leading-relaxed">
                    Oferecemos soluções completas de logística de viagem e suporte especializado para garantir que sua única preocupação seja aproveitar a experiência ao máximo.
                </p>
            </div>
        </div>
    </section>
