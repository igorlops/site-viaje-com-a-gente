                    ...
                    @forelse($pages as $page)
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.pages.edit', $page->id) }}" class="inline-flex items-center gap-1 bg-[#002752] hover:bg-[#f2bd11] hover:text-[#00152b] text-white px-3.5 py-2 rounded-lg font-bold text-xs transition duration-200">
