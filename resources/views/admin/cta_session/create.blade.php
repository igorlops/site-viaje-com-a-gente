...
@section('admin_content')
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-grow max-w-4xl bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('admin.cta_session.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                        ...
                        <label class="layout-card relative flex flex-col bg-white border-2 rounded-xl p-4 cursor-pointer hover:bg-slate-50 transition-all {{ old('layout', 'simple-band') == 'simple-band' ? 'border-[#001c3d] ring-1 ring-[#001c3d]' : 'border-gray-200' }}"
                            ...
                            <input type="radio" name="layout" value="simple-band" class="sr-only" {{ old('layout', 'simple-band') == 'simple-band' ? 'checked' : '' }}>
                        ...
                        {{-- Option 2: Split --}}
                        <label class="layout-card relative flex flex-col bg-white border-2 rounded-xl p-4 cursor-pointer hover:bg-slate-50 transition-all {{ old('layout') == 'split' ? 'border-[#001c3d] ring-1 ring-[#001c3d]' : 'border-gray-200' }}"
                               onclick="document.querySelectorAll('.layout-card').forEach(el => { el.classList.remove('border-[#001c3d]', 'ring-1', 'ring-[#001c3d]'); el.classList.add('border-gray-200'); }); this.classList.remove('border-gray-200'); this.classList.add('border-[#001c3d]', 'ring-1', 'ring-[#001c3d]');">
                            <input type="radio" name="layout" value="split" class="sr-only" {{ old('layout') == 'split' ? 'checked' : '' }}>
                        ...
                        <label class="layout-card relative flex flex-col bg-white border-2 rounded-xl p-4 cursor-pointer hover:bg-slate-50 transition-all {{ old('layout') == 'image-highlight' ? 'border-[#001c3d] ring-1 ring-[#001c3d]' : 'border-gray-200' }}"
                               onclick="document.querySelectorAll('.layout-card').forEach(el => { el.classList.remove('border-[#001c3d]', 'ring-1', 'ring-[#001c3d]'); el.classList.add('border-gray-200'); }); this.classList.remove('border-gray-200'); this.classList.add('border-[#001c3d]', 'ring-1', 'ring-[#001c3d]');">
                            <input type="radio" name="layout" value="image-highlight" class="sr-only" {{ old('layout') == 'image-highlight' ? 'checked' : '' }}>
                        ...
                        <label class="layout-card relative flex flex-col bg-white border-2 rounded-xl p-4 cursor-pointer hover:bg-slate-50 transition-all {{ old('layout') == 'floating-card' ? 'border-[#001c3d] ring-1 ring-[#001c3d]' : 'border-gray-200' }}"
                               onclick="document.querySelectorAll('.layout-card').forEach(el => { el.classList.remove('border-[#001c3d]', 'ring-1', 'ring-[#001c3d]'); el.classList.add('border-gray-200'); }); this.classList.remove('border-gray-200'); this.classList.add('border-[#001c3d]', 'ring-1', 'ring-[#001c3d]');">
                            <input type="radio" name="layout" value="floating-card" class="sr-only" {{ old('layout') == 'floating-card' ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 items-center">
                                ...
                                <div class="w-full sm:w-1/2">
                                    <input type="text" name="bg_image_url" id="bg_image_url" value="{{ old('bg_image_url') }}"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#001c3d] focus:ring-2 focus:ring-[#001c3d]/10 focus:outline-none text-sm transition bg-white"
                                        placeholder="Ou digite a URL (ex: /storage/...)">
                                </div>
                            </div>
                            <p class="text-[10px] text-gray-400 mt-1">Escolha um arquivo de imagem para fazer o upload OU digite uma URL existente (ou 'none').</p>
