...
class PageController extends Controller
{
    ...
    public function packages20262027()
    {
        ...
        return view("pacotes-2026-2027", compact("socialLinks", "banner", "destinations"));
    }
    ...
    public function services()
    {
        ...
        $socialLinks = $this->getSocialLinks();
        return view("nossos-servicos", compact("socialLinks", "banner"));
    }
    ...
    public function shortTrips()
    {
        ...
        $socialLinks = $this->getSocialLinks();
        return view("bate-e-volta", compact("socialLinks", "banner", "destinations"));
    }
    ...
    public function groupTrips()
    {
        ...
        $socialLinks = $this->getSocialLinks();
        return view("viagens-em-grupo", compact("socialLinks", "banner", "destinations"));
    }
    ...
    public function faq()
    {
        ...
        $socialLinks = $this->getSocialLinks();
        return view("perguntas-frequentes", compact("socialLinks", "banner"));
    }
    ...
    public function contact()
    {
        ...
        $socialLinks = $this->getSocialLinks();
        return view("contato", compact("socialLinks", "banner"));
    }
    ...
    public function serviceShow(string $slug)
    {
        ...
        return view('services.show', compact('service', 'socialLinks', 'menuServices', 'htmlContent', 'banner'));
    }
    public function destinationShow($slug)
    {
        ...
        return view('destination.show', compact('destination', 'socialLinks', 'banner'));
    }
    ...
    public function destinations(\App\Http\Requests\DestinationsFilterRequest $request)
    {
        ...
        return view('destination.index', compact('destinations', 'socialLinks', 'banner'));
    }
}
